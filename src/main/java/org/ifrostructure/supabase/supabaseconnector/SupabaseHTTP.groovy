...
public class SupabaseHTTP {
    ...
    // Constructor
    public SupabaseHTTP(String supabaseUrl, String apiKey) {
        this.supabaseUrl = supabaseUrl;
        this.apiKey = apiKey;
        this.httpClient = HttpClient.newHttpClient();
    }

    public HttpResponse getRequest(String url, Map<String, String> headers, Map<String, String> params) {
        try {
